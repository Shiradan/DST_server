...
return {
	ACTIONFAIL =
	{
		SHAVE =
		{
			AWAKEBEEFALO = "Are you mad? You think I would do that?.",
			GENERIC = "I can't shave that!",
			NOBITS = "It looks grotesque without its fur.",
		},
		STORE =
		{
			GENERIC = "It's full.",
	...
	ACTIONFAIL_GENERIC = "There's no way.",
	...
	ANNOUNCE_COLD = "I'm freezing out here!",
	ANNOUNCE_CRAFTING_FAIL = "Im lacking the essential components.",
	ANNOUNCE_DEERCLOPS = "I sense a giant. Beserker? Wait...",
	ANNOUNCE_DUSK = "It's getting late. I need shelter.",
	ANNOUNCE_EAT =
	{
		GENERIC = "Delicious!",
		PAINFUL = "That...wasnt...good",
		SPOILED = "Why did I eat that again?",
		STALE = "Im pretty sure I regret that",
	},
	ANNOUNCE_ENTER_DARK = "Can't see! Can't see!",
	ANNOUNCE_ENTER_LIGHT = "Feels good to see again",
	ANNOUNCE_FREEDOM = "I'm free! Outta here!",
	ANNOUNCE_HIGHRESEARCH = "Getting smarter by the minute",
	ANNOUNCE_HOUNDS = "I hear the hounds approaching!",
	ANNOUNCE_HUNGRY = "Where's Shirou? Im hungry.",
	ANNOUNCE_HUNT_BEAST_NEARBY = "What a big footprint. the beast must be nearby.",
	ANNOUNCE_HUNT_LOST_TRAIL = "Seems i've lost my target",
	ANNOUNCE_INV_FULL = "As if I can carry all this luggage!",
	ANNOUNCE_KNOCKEDOUT = "What the..my head!",
	ANNOUNCE_LOWRESEARCH = "That taught me...nothing",
	...
	ANNOUNCE_NOHUNGERSLEEP = "Where's Shirou? the growling will keep me up...",
	ANNOUNCE_NODANGERAFK = "I will not back down from this fight!",
	ANNOUNCE_NO_TRAP = "Easier than expected.",
	ANNOUNCE_PECKED = "Ow! Quit it!",
	ANNOUNCE_QUAKE = "That doesn't sound good.",
	ANNOUNCE_RESEARCH = "Never stop learning!",
	ANNOUNCE_THORNS = "Ow!",
	ANNOUNCE_TORCH_OUT = "The Light The Light! The Light!",
	ANNOUNCE_TRAP_WENT_OFF = "W-whoops.",
	ANNOUNCE_UNIMPLEMENTED = "OW! I don't think it's ready yet.",
	ANNOUNCE_WORMHOLE = "I didn't want to see the inside of that...",
	...
	BATTLECRY =
	{
		GENERIC = "Find its weak spot!",
		PIG = "Come and fight, piggy!",
		PREY = "You're nothing but a tool!",
		SPIDER = "Yuck! Spiders!",
	...
	DESCRIBE =
	{
		...
		SKELETON_PLAYER =
		{
			MALE = "%s died like an idiot. Being hurt by %s.",
	...
	DESCRIBE_TOODARK = "I can't see! I can't see!",
	EAT_FOOD =
	{
