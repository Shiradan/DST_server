...
return {
	ACTIONFAIL =
	{
		SHAVE =
		{
			AWAKEBEEFALO = "Lets eat it now.",
			GENERIC = "I wanted to eat it anyway.",
			NOBITS = "...",
		},
		STORE =
		{
			GENERIC = "Can't fit any more meat here...",
			NOTALLOWED = "That can't go in there.",
			INUSE = "This other person should hurry up.",
		},
		RUMMAGE =
		{	
			GENERIC = "I can't do that.",
			INUSE = "What's taking so long?",	
		},
	},
	...
	ANNOUNCE_COLD = "Not shorts and open shirt weather!",
	ANNOUNCE_CRAFTING_FAIL = "Needed more meat...",
	ANNOUNCE_DEERCLOPS = "I hear something fun coming!",
	ANNOUNCE_DUSK = "It's getting late, can't miss dinner time!",
	ANNOUNCE_EAT =
	{
		GENERIC = "YUMMMMMMM!",
		PAINFUL = "NIku Niku Niku!",
		SPOILED = "Yuck! I want better food instead.",
		STALE = "Never eating that again.",
	},
	ANNOUNCE_ENTER_DARK = "THE SEA MONSTERS ARE COMING!",
	ANNOUNCE_ENTER_LIGHT = "I can see again!",
	ANNOUNCE_FREEDOM = "Time to set sail!",
	ANNOUNCE_HIGHRESEARCH = "I feel so smart now!",
	ANNOUNCE_HOUNDS = "Lets take these creatures down!",
	ANNOUNCE_HUNGRY = "I'm starving, where's the meat!?",
	ANNOUNCE_HUNT_BEAST_NEARBY = "This track is fresh, the meat must be nearby.",
	...
	ANNOUNCE_NODANGERSLEEP = "I guess it's too dangerous right now!",
	...
	ANNOUNCE_WORMHOLE = "Let's do that again!",
	...
	BATTLECRY =
	{
		GENERIC = "GOMU GOMU NO...",
		PIG = "GOMU GOMU NO...",
		PREY = "GOMU GOMU NO...",
		SPIDER = "GOMU GOMU NO...",
		SPIDER_WARRIOR = "GOMU GOMU NO...",
	},
	COMBAT_QUIT =
	{
	...
	DESCRIBE =
	{
		...
		WILSON = 
		{
			GENERIC = "Come join my crew Wilson!",
		...
		WOLFGANG = 
		{
			GENERIC = "Come join my crew Wolfgang!",
		...
		WAXWELL = 
		{
			GENERIC = "Come join my crew Maxwell!",
		...
		WX78 = 
		{
			GENERIC = "Come join my crew WX-78!",
		...
		WILLOW = 
		{
			GENERIC = "Come join my crew Willow!",
		...
		WENDY = 
		{
			GENERIC = "Come join my crew Wendy!",
		...
		WOODIE = 
		{
			GENERIC = "Come join my crew Woodie!",
		...
		WICKERBOTTOM = 
		{
			GENERIC = "Come join my crew Wickerbottom!",
		...
		RUINSHAT = "Fit for a Pirate king!.",
		NIGHTMARE_TIMEPIECE =
		{
		CALM = "All is good.",
		...
		COMPASS =
		{
			GENERIC="Where's Nami when  I need her.",
			N = "North",
			S = "South",
			E = "East",
			W = "West",
		...
		HOUNDSTOOTH="Can I use this as teeth too?",
		...
		SPIDER_HIDER="BRING ON THE SPIDERS!",
		...
		BABYBEEFALO = "Has to grow a bit before I eat it.",
		BACKPACK = "Lots of space for food.",
		BACONEGGS = "Cooked just how Sanji does it.",
		...
		{
			FOLLOWER = "Meat...Meat...",
			GENERIC = "Can you poop?",
			NAKED = "I can see the meat clearly.",
			SLEEPING = "Sleeping Meat...",
		},
		...
		BERRYBUSH =
		{
			...
			GENERIC = "Red berries are ok, meat is better though.",
		...
		BOARDS = "Boards.",
		BOAT = "Is that suppose to be Thousand Sunny?",
		...
		BUTTERFLY =
		{
			GENERIC = "LETS CATCH THAT BUTTERFLY.",
			HELD = "Now I have you!",
		},
		...
		CAMPFIRE =
		{
			EMBERS = "HURRY FEED THE FIRE!",
			GENERIC = "TIME TO DANCE AROUND THE FIRE!",
			HIGH = "TIME TO DANCE AROUND THE FIRE!",
			LOW = "Can't dance around this small fire...",
			NORMAL = "TIME TO DANCE AROUND THE FIRE!",
			OUT = "Well, the party is over...",
		},
		...
		COOKEDMEAT = "yesssss meeeeeat.",
		COOKEDMONSTERMEAT = "I fought this monster earlier. TIME TO EAT!",
		COOKEDSMALLMEAT = "I wish I had more meat.",
		COOKPOT =
		{
		...
		CORN = "Wish it was meat.",
		CORN_COOKED = "Wish it was meat",
		...
		FARMPLOT =
		{
			GENERIC = "Farming means more food right.",
			GROWING = "Go plants go!",
			NEEDSFERTILIZER = "I think it needs poop.",
		},
		...
		FROG =
		{
			...
			GENERIC = "Let's eat it.",
			SLEEPING = "Let's eat it while it's sleeping.",
		},
		...
		PIGKING = "Join my crew!",
		PIGMAN =
		{
			DEAD = "Someone should tell his family.",
			FOLLOWER = "He's part of my crew!",
		...
		ROBIN =
		{
			GENERIC = "Is that you Robin?",
			HELD = "She likes my pocket.",
		},
		ROBIN_WINTER =
		{
			GENERIC = "Is that you Robin?",
		...
		{
			BURNING = "That's burning fast!",
			GENERIC = "These baby trees will grow strong someday!",
		...
		SPIDERQUEEN = "AHHHHHHHH! GET READY FOR A FIGHT!",
		SPIDER_WARRIOR =
		{
			DEAD = "Good riddance!",
		...
		SKELETON_PLAYER =
		{
			MALE = "%s died during his adventure. Being hurt by %s.",
			FEMALE = "%s died during her adventure. Being hurt by %s.",
			ROBOT = "%s died during his adventure. Being hurt by %s.",
		},
