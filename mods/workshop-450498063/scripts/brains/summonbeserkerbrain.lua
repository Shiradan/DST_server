...
local SummonBeserker = Class(Brain, function(self, inst)
	Brain._ctor(self, inst)
end)

function SummonBeserker:OnStart()
	local root = PriorityNode({
		...
		WhileNode(function() return IsTakingFireDamage(self.inst) end, "On Fire",
			ChattyNode(self.inst, STRINGS.SUMMONBESERKER_TALK_PANICFIRE, Panic(self.inst))),
