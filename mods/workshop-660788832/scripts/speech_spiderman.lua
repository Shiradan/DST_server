...
return {
	...
	BATTLECRY =
	{
		...
		Spiderman = "I'm going to stomp you dead!",
		Spiderman_WARRIOR = "Better you than me!",
	},
	COMBAT_QUIT =
	{
		...
		PREY = "He's too fast!",
		Spiderman = "He's too gross, anyway.",
		Spiderman_WARRIOR = "Shoo, you nasty thing!",
	},
	DESCRIBE =
	{
		...
		Spiderman_DROPPER = "Note to self: Don't look up.",
        ...
        MUSHTREE_TALL_WEBBED = "The spidermans thought this one was important.",
		...
		Spiderman_HIDER="Gah! More spidermans!",
		Spiderman_SPITTER="I hate spidermans!",
		SpidermanHOLE="It's encrusted with old webbing.",
		...
		SILK = "It comes from a spiderman's butt.",
		...
		{
			DEAD = "Ewwww!",
			GENERIC = "I hate spidermans.",
			SLEEPING = "I'd better not be here when he wakes up.",
		},
		SpidermanDEN = "Sticky!",
		SpidermanEGGSACK = "I hope these don't hatch in my pocket.",
		SpidermanGLAND = "It has a tangy, antiseptic smell.",
		SpidermanHAT = "I hope I got all of the spiderman goo out of it.",
		SpidermanQUEEN = "AHHHHHHHH! That spiderman is huge!",
		Spiderman_WARRIOR =
		{
			DEAD = "Good riddance!",
