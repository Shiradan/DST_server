...
return {
	...
	ANNOUNCE_ADVENTUREFAIL = "We have to live a life of no regrets.",
	...
	ANNOUNCE_COLD = "Where's the fire?!",
	...
	ANNOUNCE_EAT =
	{
		GENERIC = "Tastes great!",
		PAINFUL = "Maybe I shouldn't have ate that.",
		SPOILED = "GROSS!",
		STALE = "I think that was starting to turn.",
	},
	ANNOUNCE_ENTER_DARK = "Where's the fire?!",
	ANNOUNCE_ENTER_LIGHT = "I can see the light!",
	ANNOUNCE_FREEDOM = "I'm free! I'm finally free!",
	ANNOUNCE_HIGHRESEARCH = "I feel so smart now!",
	ANNOUNCE_HOUNDS = "Something wants to pick a fight...",
	ANNOUNCE_HUNGRY = "Where's the food!",
	...
	DESCRIBE =
	{
		...
		CAMPFIRE =
		{
			EMBERS = "I should light the fire.",
			GENERIC = "More fire the better.",
			HIGH = "Burnnnnn.",
			LOW = "I should light the fire.",
