...
return {
	ACTIONFAIL =
	{
		SHAVE =
		{
			AWAKEBEEFALO = "Not worth it...",
			GENERIC = "No.",
			NOBITS = "No fur to cut.",
		},
		STORE =
		{
			GENERIC = "It's full.",
			NOTALLOWED = "That can't go in there.",
			INUSE = "Won't you hurry up?",
		},
		RUMMAGE =
		{	
			GENERIC = "No.",
	...
	ANNOUNCE_BEES = "Annoyance...",
	ANNOUNCE_BOOMERANG = "Ech, how did I miss that?",
	ANNOUNCE_CHARLIE = "Come face me.",
	ANNOUNCE_CHARLIE_ATTACK = "Tch!",
	ANNOUNCE_COLD = "Freezing...",
	ANNOUNCE_CRAFTING_FAIL = "I don't have all of the ingredients.",
	ANNOUNCE_DEERCLOPS = "A monster is approaching.",
	ANNOUNCE_DUSK = "It's getting late. It will be dark soon.",
	ANNOUNCE_EAT =
	{
		GENERIC = "Mmm.",
		PAINFUL = "That was horrible.",
		SPOILED = "Disgusting.",
		STALE = "Ech. No.",
	},
	ANNOUNCE_ENTER_DARK = "...",
	ANNOUNCE_ENTER_LIGHT = "Ah, better.",
	ANNOUNCE_FREEDOM = "What a fun experience.",
	ANNOUNCE_HIGHRESEARCH = "...I see",
	ANNOUNCE_HOUNDS = "Monsters approaching.",
	ANNOUNCE_HUNGRY = "I want Häagen-Dazs right now...",
	ANNOUNCE_HUNT_BEAST_NEARBY = "This track is fresh, the beast must be nearby.",
	ANNOUNCE_HUNT_LOST_TRAIL = "The trail ends here.",
	ANNOUNCE_INV_FULL = "I won't.",
	ANNOUNCE_KNOCKEDOUT = "Ugh.",
	ANNOUNCE_LOWRESEARCH = "...Learned nothing",
	ANNOUNCE_MOSQUITOS = "Annoying Pest.",
	ANNOUNCE_NODANGERSLEEP = "No, not now.",
	ANNOUNCE_NODAYSLEEP = "It's too bright out...",
	ANNOUNCE_NODAYSLEEP_CAVE = "I'm not tired.",
	ANNOUNCE_NOHUNGERSLEEP = "Häagen-Dazs..Häagen-Dazs..Häagen-Dazs",
	ANNOUNCE_NODANGERAFK = "No. I can win this.",
	ANNOUNCE_NO_TRAP = "Esay.",
	ANNOUNCE_PECKED = "Stop it.",
	...
	ANNOUNCE_UNIMPLEMENTED = "...! The trap isn't set right!",
	ANNOUNCE_WORMHOLE = "Nothing unnatural here.",
	ANNOUNCE_CANFIX = "\nI can repair this.",
	ANNOUNCE_ACCOMPLISHMENT = "Not bad. Not bad at all.",
	ANNOUNCE_ACCOMPLISHMENT_DONE = "If only Mikiya could see me now...",	
	ANNOUNCE_BECOMEGHOST = "ooOOoooOOOoOooo!!",
	ANNOUNCE_GHOSTDRAIN = "My humanity is about to start slipping away...",

	DESCRIBE_SAMECHARACTER = "Heh.",
	
	BATTLECRY =
	{
		GENERIC = "Come here.",
		PIG = "I'll gladly cut you.",
		PREY = "Goodbye.",
		SPIDER = "Goodbye Spider.",
		SPIDER_WARRIOR = "Dissapear.",
	},
	COMBAT_QUIT =
	{
		GENERIC = "Ouch.",
		...
		PREY = "How annoying.",
		SPIDER = "Eh.",
		SPIDER_WARRIOR = "Dissapear you creature.",
	},
	DESCRIBE =
	{
        PLAYER =
		...
		MULTIPLAYER_PORTAL = "Ugh, so your the reason why I'm here. Take me back will you...",
		WORMLIGHT = "Looks good.",
		WORM =
		{
		    PLANT = "Seems safe to me.",
		    DIRT = "Just looks like a pile of dirt.",
		    WORM = "Tch, caught offguard!",
		},
		MOLE =
		{
		...
		ROOK_NIGHTMARE = "How intimidating",
		KNIGHT_NIGHTMARE = "It's a robot horse thing. Okay then.",
		...
		MULTITOOL_AXE_PICKAXE = "I prefer my knife.",
		...
		HOUNDSTOOTH="What a sharp object.",
		ARMORSNURTLESHELL="Really don't think this fits me...",
		BAT="Nothing but a hindrance!",
		...
		FLOWER_CAVE="Cool.",
		FLOWER_CAVE_DOUBLE="Cool.",
		FLOWER_CAVE_TRIPLE="Cool.",
		GUANO="Oh boy, different poop.",
		...
		SPIDER_SPITTER="Stop annoying me!",
		...
		ARMORGRASS = "I find this really silly.",
		ARMORMARBLE = "This will only cause me problems...",
		ARMORWOOD = "I guess if i have to wear it...",
		...
		AXE = "It's a weapon I don't really care about.",
		BABYBEEFALO = "Cute.",
		BACKPACK = "I really don't carry much but...",
		BACONEGGS = "Heh, I ain't half-bad.",
		...
		BLUEPRINT = "I guess I understand it.",
		...
		BONESTEW = "Heh, it ain't half-bad.",
		...
		BUTTERFLYMUFFIN = "Heh, it ain't half-bad.",
		...
		FISHSTICKS = "Heh, I ain't half-bad.",
		FISHTACOS = "Heh, I ain't half-bad.",
		...
		FLOWER_EVIL = "What a weird flower...",
		...
		SPIDERHAT = "I don't enjoy wearing this.",
		SPIDERQUEEN = "I'm cutting that sack in two.",
		SPIDER_WARRIOR =
		{
			DEAD = "Good riddance!",
		...
		SKELETON_PLAYER =
		{
			MALE = "You didn't get far did ya, %s? Killed by %s.",
			FEMALE = "You didn't get far did ya, %s? Killed by %s.",
			ROBOT = "You didn't get far did ya, %s? Killed by %s.",
		},
	...
	DESCRIBE_TOODARK = "Hrm..can't see much.",
	EAT_FOOD =
	{
