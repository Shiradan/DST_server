...
return {
	...
	ANNOUNCE_HUNGRY = "We must eat. Hunger is our enemy.",
	...
	ANNOUNCE_BECOMEGHOST = "When will the next holy grail war be...?",
	...
	DESCRIBE =
	{
		...
		MULTIPLAYER_PORTAL = "The portal that sent me to this world... Was this the will of the holy grail?",
        MIGRATION_PORTAL = {
		...
		BLUEPRINT = "Is this Alchemy?!",
		BELL_BLUEPRINT = "Is this Alchemy?!",
		...
		SKELETON = "Another fallen warrior...",
