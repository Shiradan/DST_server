...
return {
	...
	BATTLECRY =
	{
		...
		DEADPOOL = "I'm going to stomp you dead!",
		DEADPOOL_WARRIOR = "Better you than me!",
	},
	COMBAT_QUIT =
	{
		...
		PREY = "He's too fast!",
		DEADPOOL = "He's too gross, anyway.",
		DEADPOOL_WARRIOR = "Shoo, you nasty thing!",
	},
	DESCRIBE =
	{
		...
		DEADPOOL_DROPPER = "Note to self: Don't look up.",
        ...
        MUSHTREE_TALL_WEBBED = "The deadpools thought this one was important.",
		...
		DEADPOOL_HIDER="Gah! More deadpools!",
		DEADPOOL_SPITTER="I hate deadpools!",
		DEADPOOLHOLE="It's encrusted with old webbing.",
		...
		SILK = "It comes from a deadpool's butt.",
		...
		{
			DEAD = "Ewwww!",
			GENERIC = "I hate deadpools.",
			SLEEPING = "I'd better not be here when he wakes up.",
		},
		DEADPOOLDEN = "Sticky!",
		DEADPOOLEGGSACK = "I hope these don't hatch in my pocket.",
		DEADPOOLGLAND = "It has a tangy, antiseptic smell.",
		DEADPOOLHAT = "I hope I got all of the deadpool goo out of it.",
		DEADPOOLQUEEN = "AHHHHHHHH! That deadpool is huge!",
		DEADPOOL_WARRIOR =
		{
			DEAD = "Good riddance!",
