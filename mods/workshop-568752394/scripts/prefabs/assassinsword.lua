local assets=
{
    Asset("ANIM", "anim/assassinsword.zip"),
    Asset("ANIM", "anim/swap_assassinsword.zip"),
  
    Asset("ATLAS", "images/inventoryimages/assassinsword.xml"),
    Asset("IMAGE", "images/inventoryimages/assassinsword.tex"),
}
...
local function OnEquip(inst, owner)
    owner.AnimState:OverrideSymbol("swap_object", "swap_assassinsword", "swap_assassinsword")
...
local function fn()
    ...
    inst.AnimState:SetBank("assassinsword")
    inst.AnimState:SetBuild("assassinsword")
    ...
    inst.components.inventoryitem.imagename = "assassinsword"
    inst.components.inventoryitem.atlasname = "images/inventoryimages/assassinsword.xml"
...
return  Prefab("common/inventory/assassinsword", fn, assets, prefabs) 