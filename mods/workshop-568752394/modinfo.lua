...
name = "Caster(Fate/Stay Night)(W)"
description = "From Fate/Stay Night."
author = "Silhh and Arcade"
...
{
    {
        ...
        hover = "This is the key use to transform Tamamo.",
        options =
        {
	...
	{
		name = "healthvalue",
		label = "Caster health cast",
		hover = "Health consumption for Caster projectile",
		options = {
	...
	{
		name = "sanityvalue",
		label = "Caster sanity cast",
		hover = "Sanity consumption for Caster projectile.",
		options = {
						{description = "1", data = -1},
						{description = "5", data = -5},
